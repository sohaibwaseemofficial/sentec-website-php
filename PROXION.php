...
$event_data = [
    "Technical Modules" => [
        ...
        "modules" => [
            ["⚡", "Speed Programming", "Code Rush", "A fast-paced competition designed to test the quick-thinking and efficiency of programmers in solving algorithmic problems.",  "500", "Max 4","rules/code-rush.pdf"],
            ["🧠", "Competitive Programming", "Algo Masters", "An advanced track focusing on complex data structures and high-level algorithmic efficiency for seasoned programmers.",  "500", "Max 4","rules/algo-masters.pdf"],
            ["🏁", "Code Sprint", "Race with Code", "A timed challenge where participants must write efficient code for specific tasks against a ticking clock.",  "500", "Max 4","rules/race-with-code.pdf"],
            ["🎨", "UI/UX Design", "Design Sprint", "A creative module where participants design intuitive user interfaces and experiences for modern digital applications.",  "500", "Max 4","rules/design-sprint.pdf"],
            ["📱", "App Development", "App Innovate", "A comprehensive challenge where teams move from ideation to the development phase of a functional application.",  "500", "Max 4","rules/app-innovate.pdf"],
            ["🗄️", "Database Mastery", "Query Quest", "Solve real-world SQL challenges, leveling up from basic queries to complete database mastery and optimization.",  "500", "Max 4","rules/query-quest.pdf"],
            ["🐛", "Debugging", "Bug Busters", "A hands-on module where contestants are tasked with identifying and fixing errors in pre-written, broken code.",  "500", "Max 4","rules/bug-busters.pdf"],
            ["🌐", "Web Development", "Web Wizards", "A contest focused on the design and functional implementation of modern, highly responsive websites.",  "500", "Max 4","rules/web-wizards.pdf"],
            ["😂", "Logic Game", "Emoji Algorithm", "A fun yet challenging module that requires participants to represent complex programming logic using only emojis.",  "500", "Max 4","rules/emoji-algorithm.pdf"],
            ["➕", "Maths Olympiad", "Maths Clash", "A high-stakes Mathematics Olympiad where competitors race against the clock to solve mathematical challenges and mind-bending logic puzzles.",  "500", "Individual","rules/maths-clash.pdf"]
        ]
    ],
    "Battle Arena" => [
        "desc" => "Battle it out in top-tier competitive gaming tournaments to prove your mechanical skills and teamwork.",
        "modules" => [
        ["🎮", "5v5 Tactical", "Valorant", "A highly competitive 5v5 character-based tactical shooter tournament.", "1000", "5 Members","rules/valorant.pdf"],
            ["🔫", "5v5 Classic", "CS 2", "The next evolution of Counter-Strike, featuring upgraded engine mechanics and tactical depth.", "1000", "5 Members","rules/cs-2.pdf"],
            ["📱", "5v5 Multiplayer", "COD Mobile", "Dominate the mobile battlefield in high-intensity multiplayer modes. Teamwork and precision are key.", "1000", "5 Members", "rules/codm.pdf"],
            ["🍗", "Classic Battle Royale", "PUBG Mobile", "The ultimate survival test. 100 players drop, but only one squad secures the Chicken Dinner through strategic positioning, survival instincts, and high-stakes combat.", "1000", "4 Members", "rules/pubg.pdf"]
            ...
            <div class="card-3d-inner">
              ...
              <div class="card-3d-overlay">
                <div class="card-3d-text">
                  ...
                  <h3>3 Days. 10+ Modules. One Champion.</h3>
                  ...
                  <div class="card-stats">
                    <div class="stat"><span>10+</span><label>Modules</label></div>
                    <div class="stat"><span>100+</span><label>Participants</label></div>
                    <div class="stat"><span>3</span><label>Days</label></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="module-card esport-card reveal-card" 
                    ...
                    <div class="module-card-inner">
                        <div class="card-header-top">
                            ...
                            <div class="card-team-pill"><?= $m[5] ?></div>
                        </div>
                    ...
                    <div class="modal-body pt-0">
                        ...
                        <div class="mb-4">
                            <div class="p-3 rounded-4 text-center" style="background: rgba(155, 111, 212, 0.1); border: 1px solid rgba(155, 111, 212, 0.2);">
                                <span class="prize-label-sm">REGISTRATION FEE</span>
                                <div class="prize-value-lg">Rs. <?= $m[4] ?></div>
                            </div>
                        </div>
                        <a href="login" 
