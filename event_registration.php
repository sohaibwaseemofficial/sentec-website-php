...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('multiStepRegForm').addEventListener('submit', function(e) {
            ...
            .catch(err => {
                alertDiv.style.display = 'block';
                alertDiv.innerHTML = `<div style="background: rgba(248,113,113,0.1); border: 1px solid rgba(248,113,113,0.4); color: #f87171; padding: 14px; font-family: 'IBM Plex Mono', monospace; font-size: 12px;">${err.message || 'Network error. Check internet connection or file sizes.'}</div>`;
                btn.disabled = false;
                btnText.textContent = "SUBMIT REGISTRATION";
            });
        });
