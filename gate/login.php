...
$GATE_PASSWORD = env('SOCIAL_GATE_PASSCODE', 'sentec_social_night');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['password'] === $GATE_PASSWORD) {
        $_SESSION['is_gatekeeper'] = true;
        header("Location: index.php");
        exit;
    } else {
...
<body>
    <div class="card">
        ...
        <p style="color:#888; margin-bottom: 30px;">Volunteer Access Portal</p>
